...
public final class ModMemories {
	...
	public static void init() {
		...
		Registry.register(Registries.MEMORY_MODULE_TYPE, UMULittleMaid.identifier("delivery_boxes"), DELIVERY_BOXES);
		...
		Registry.register(Registries.MEMORY_MODULE_TYPE, UMULittleMaid.identifier("farm_cooldown"), FARM_COOLDOWN);
