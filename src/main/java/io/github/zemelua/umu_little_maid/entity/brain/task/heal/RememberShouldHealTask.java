...
public class RememberShouldHealTask<E extends LivingEntity & IHasMaster> extends MultiTickTask<E> {
	private static final Map<MemoryModuleType<?>, MemoryModuleState> REQUIRED_MEMORIES = ImmutableMap.of(
			ModMemories.SHOULD_HEAL, MemoryModuleState.VALUE_ABSENT
	);
	...
	protected void run(ServerWorld world, E living, long time) {
		...
		brain.remember(ModMemories.SHOULD_HEAL, Unit.INSTANCE);
	}
}
